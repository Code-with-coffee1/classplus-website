...
exports.sendEmail = (req, res) => {
  new_branch.findById(req.body.branch_id, (err, branch) => {
    const mailOptions = {
      template: "admin_mail",
      message: {
      ...
      locals: {
        ...
        teacher: branch.postedBy.name,
        batch: branch.title,
      },
    };
    console.log(mailOptions);
    email.send(mailOptions).then((error, info) => {
      if (error) {
...
exports.list = (req, res) => {
  ...
  new_branch
    .find({ "postedBy._id": req.query.admin })
    .sort({ createdAt: "desc" })
